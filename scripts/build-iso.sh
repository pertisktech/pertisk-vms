...
chmod 755 "$OVERLAY/usr/sbin/pertisk-kvm-check" "$OVERLAY/usr/sbin/pertisk-firstboot" "$OVERLAY/usr/sbin/pertisk-install" "$OVERLAY/usr/sbin/pertisk-host-bridge" "$OVERLAY/usr/sbin/pertisk-bootfix" "$OVERLAY/usr/sbin/pertisk-esp-boot" "$OVERLAY/usr/sbin/pertisk-net" "$OVERLAY/usr/sbin/pertisk-console" "$OVERLAY/usr/sbin/pertisk-fix-nvme-boot" "$OVERLAY/usr/sbin/pertisk-uefi-register"
