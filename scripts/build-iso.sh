...
chmod 755 "$OVERLAY/usr/sbin/pertisk-kvm-check" "$OVERLAY/usr/sbin/pertisk-firstboot" "$OVERLAY/usr/sbin/pertisk-install" "$OVERLAY/usr/sbin/pertisk-host-bridge" "$OVERLAY/usr/sbin/pertisk-bootfix"
