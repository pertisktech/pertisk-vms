...
The appliance opens a local root shell on its physical or QEMU serial console. The Pertisk web account remains `admin`; its password is in `/etc/pertisk/admin`.
